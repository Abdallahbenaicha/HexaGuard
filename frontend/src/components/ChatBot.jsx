      ...
      <div className={`max-w-[88%] ${isUser ? 'items-end' : 'items-start'} flex flex-col gap-1`}>
        <div ref={bubbleRef} className={`rounded-2xl px-4 py-3 text-[12px] leading-relaxed font-inter ${
          ...
          {isUser ? (
            ...
            <div className="prose-hexaguard" dangerouslySetInnerHTML={{ __html: renderMarkdown(msg.content) }} />
          )}
        </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mt-0.5">
            <p className="text-[9px] text-gray-500 font-inter">HexaGuard AI Security Expert</p>
