...
SecurAx employs a sophisticated dual-engine AI strategy:
...
SecurAx is deeply rooted in academic and industry standards:
- **OWASP Top 10 (2025):** SecurAx programmatically maps to categories A01 through A10.
...
- **Stateless Architecture:** SecurAx requires no traditional relational database for core scanning, opting for a stateless design where reports are generated ephemerally or stored flat. 
...
SecurAx represents a paradigm shift for SMEs and academic environments: it requires zero installation time, provides unparalleled breadth (Network + DAST + SAST + Config), and leverages AI to translate complex technical findings into actionable, compliance-ready executive intelligence.

***

# SecurAx — UML DIAGRAMS

The following PlantUML diagrams illustrate the design, architecture, and behavioral flow of the SecurAx platform.
...
SecurAxAgent "1" *-- "1" ReportGenerator : uses >
