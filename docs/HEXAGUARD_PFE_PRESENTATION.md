...
HexaGuard employs a sophisticated dual-engine AI strategy:
...
HexaGuard is deeply rooted in academic and industry standards:
- **OWASP Top 10 (2025):** HexaGuard programmatically maps to categories A01 through A10.
...
- **Stateless Architecture:** HexaGuard requires no traditional relational database for core scanning, opting for a stateless design where reports are generated ephemerally or stored flat. 
...
HexaGuard represents a paradigm shift for SMEs and academic environments: it requires zero installation time, provides unparalleled breadth (Network + DAST + SAST + Config), and leverages AI to translate complex technical findings into actionable, compliance-ready executive intelligence.

***

# HexaGuard — UML DIAGRAMS

The following PlantUML diagrams illustrate the design, architecture, and behavioral flow of the HexaGuard platform.
...
HexaGuardAgent "1" *-- "1" ReportGenerator : uses >
